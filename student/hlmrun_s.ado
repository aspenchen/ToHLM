...
-------------------------------------------------*/
capture program drop hlmrun_s
program define hlmrun_s, eclass
ereturn clear

version 8.2
	syntax anything (id="hlm cmdfile" name=filename) ///
	[, hlm2s hlm3ss noView MDM(string) STore(string) ROBUST]
...
if "`hlm2s'"=="hlm2s" & "`hlm3s'"=="hlm3s"  error 197 // "invalid syntax"
else if "`hlm2s'"=="" & "`hlm3s'"=="" local hlm2s "hlm2s"
...
*tau information matrix not included in hlm2s tauvc.dat file?
